...
const AppSidebar = ({ items }) => {
  ...
  return (
    <Sidebar>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-sidebar-foreground/70">Links</SidebarGroupLabel>
          ...
          <SidebarGroupContent className={'bg-sidebar'}>
            <SidebarMenu>
              {categoriesLoading ? (
                <SidebarMenuItem>
                  <div className="flex items-center gap-2 p-2 text-sm text-sidebar-foreground/60">
      ...
      </SidebarContent>      <SidebarFooter className="bg-sidebar border-t border-sidebar-border">
        {user && (
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <div className="flex items-center gap-3 p-2 hover:bg-sidebar-accent rounded-md cursor-pointer transition-colors">
